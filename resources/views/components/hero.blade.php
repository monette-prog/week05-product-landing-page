<section id="home" class="relative overflow-hidden bg-[#075E59] text-white">
    
    {{-- DECORATIVE BUBBLES --}}
    <div class="pointer-events-none absolute -left-20 top-20 h-56 w-56 rounded-full bg-teal-300/10"></div>
    <div class="pointer-events-none absolute -right-20 top-10 h-64 w-64 rounded-full bg-teal-200/10"></div>
    <div class="pointer-events-none absolute right-48 bottom-[-90px] h-56 w-56 rounded-full bg-teal-300/10"></div>
    <div class="pointer-events-none absolute left-1/3 bottom-[-120px] h-72 w-72 rounded-full bg-teal-200/5"></div>
                ...
                <div class="overflow-hidden rounded-2xl bg-white shadow-2xl">
                    ...
                    <div class="p-5 text-gray-800">
                        ...
                        <div class="mt-5 grid grid-cols-6 gap-2 text-center">
                            ...
                            <div>
                                <div class="mx-auto flex h-8 w-8 items-center justify-center rounded-full bg-teal-50">🚚</div>
                                <p class="mt-1 text-[9px] text-gray-500">Delivery</p>
                            </div>

                            <div>
                                <div class="mx-auto flex h-8 w-8 items-center justify-center rounded-full bg-teal-50">🛍️</div>
